...
def getModelConfig():
    ...
    #model_stacked = Sequential()
    #model_stacked.add(LSTM(24, input_shape=(300,8), return_sequences=True,))
    #model_stacked.add(LSTM(24))
    #model_stacked.add(Dense(4, activation='leaky_relu'))
    #model_stacked.add(Dense(1, activation='sigmoid'))
    
    #model_stacked.add(LSTM(36, input_shape=(300,8), return_sequences=True,))
    #model_stacked.add(LSTM(24))
    #model_stacked.add(Dense(4, activation='leaky_relu'))
    #model_stacked.add(Dense(1, activation='sigmoid'))

    model_stacked.add(LSTM(36, input_shape=(300,8), return_sequences=True,))
    model_stacked.add(LSTM(24, return_sequences=True))
    model_stacked.add(LSTM(24))
    model_stacked.add(Dense(4, activation='leaky_relu'))
    model_stacked.add(Dense(1, activation='sigmoid'))
    ...
    models['model_stacked'] = model_stacked
    return models
...
if __name__ == '__main__':
    ...
    trainData = convertArffToDataFrame("/home/notroot/Downloads/train_test_data_output/2023-10-23T23;36;37.310313800 anat,conf/trainData_2000.0mssec_window_1.arff")
    ...
    validationData = convertArffToDataFrame("/home/notroot/Downloads/train_test_data_output/2023-10-23T23;36;37.310313800 anat,conf/testData_2000.0msec_window_1.arff")
